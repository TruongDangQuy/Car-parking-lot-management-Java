...
public class EditCustomer extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String idname=request.getParameter("code");
        UserCustomer uc=new UserCustomer();
        uc=DBUtils.getUserCustomer(conn, idname, idname, idname, idname,idname,idname);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
           ...
           image="Images/"+fileName;
            ...
            DBUtils.updateUserCustomer(conn,idname,name,email,phone,birth,image);
